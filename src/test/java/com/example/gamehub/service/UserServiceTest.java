...
class UserServiceTest {
    ...
    void hashedPasswordBeforeSaving(){
        ...
        when(passwordEncoder.encode("newPassword1"))
                .thenReturn("encodedNewPassword1");
// this creates the actual class under test, now handing it two fake dependencies via the constructor
